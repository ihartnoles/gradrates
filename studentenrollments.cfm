...
<cfquery name="getStudentCourses" datasource="#application.dsn#">
							...
							<div class="box">
								<div class="box-title">
									<h3>
										...
										Spring 2014 - Courses for <cfoutput>  #getStudentCourses.student_first_name#  #getStudentCourses.student_last_name# </cfoutput>
									</h3>
								</div>
																				...
																				<td class="hidden-350">
																					<div class="control-group">
																						...
																						<div class="controls">
																							...
																							<label class="radio">
																								<input type="radio" class="noissues" name="atrisk-#getStudentCourses.currentrow#-#getEnrollments.currentrow#" value="0" data-students_courses_id="#getEnrollments.STUDENTS_COURSES_ID#" <cfif getStatuses.status EQ 0>checked</cfif>> No issues
																							</label>																							
																						</div>
																					</div>
																				</td>
       ...
       <cfoutput>
        $(function () {
				...
				$(".closeButton").click(function(e) {
						...
						window.location.href = "studentenrollments.cfm?znumber=" + znumber;
				});
